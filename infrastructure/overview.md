...
* 資料伺服器
  ...
  * 早期 Parse BAAS 服務提供了非常完整的後端服務，完整滿足了 Indie Game 開發者的需求，讓開發者更能專注在遊戲的開發。時至今日，Parse 雖然轉移成了 Self-Hosted 服務，甚至還包含了帳號系統，伺服器邏輯，任務服務...，卻也剛好能滿足資料自主性的需求。除此之外 Parse 在資料多樣化取用、管理呈現、彈性的權限管控都有很完整的解決方案
* 應用程式介面
* “即時性”服務
