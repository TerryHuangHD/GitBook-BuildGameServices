...
這個系列的名字為「Backend of Indie Game: 自建獨立遊戲服務」，是 LiRise Games 在開發『呆呆夥伴』系列遊戲時，後端開發的心得筆記；和其他 Indie Game 開發者一樣，我們這次的開發過程中，嘗試在使用有限資源的狀況下，用簡易的方法來建立跨平台的「遊戲體驗」。希望我們的經驗能對其他 Indie Game 開發者有所幫助。後續內容將會依序介紹，各式遊戲相關的 BaaS 和其他外部服務，接著會在此基礎架構下，介紹各種常見的 Game Services 的設計與心得
...
* Infrastructure
  * 依照步驟簡單的建立所需要的基礎服務，包含 Database, Parse Service, Firebase 以及其他服務的設定，比如：API, Realtime, Notification, Job, Email, SMS, Hosting, Time
* Game Services
...
Terry Huang \(@kmshiori\) ，業餘電動玩家，Overwatch 打不上 3000，求大神帶 \(BattleNet: kmshiori\#3943)。絕地求生吃雞和喝水一樣簡單，歡迎~~（加入戰隊）~~一起遊戲 \(Steam: kmshiori@gmail.com)。或是加個好友認識一下 \(FB: kmshiori@gmail.com)
