...
後續內容將使用 Parse 服務為基底，進階整合其他網路服務\(Firebase, FCM, AWS SES...\)，從最基礎的「Infrastructure 架構」進行介紹與「Step by Step 架設教學」，接著會介紹在此架構下，各種常見的「遊戲後端」服務設計與心得分享。希望能夠為 Indie Game 帶來更多的元素。
