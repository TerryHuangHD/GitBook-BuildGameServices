...
Parse 的服務架構中，基本上需包含「資料庫服務」、以及「Parse Server 服務」。為了滿足各式的需求，Parse 架構支援了相當多樣的服務架設方法，以下列舉一些常見的方法
...
* #### 全虛擬機架設
  全虛擬機架設，是最完整的自架服務法，在 Infrastructure as a Service（以下稱 IaaS）供應商中以虛擬機架設服務，通常用於**「上線服務」**，通常包含一台 Dedicated 資料庫伺服器，以及各 Parse 服務虛擬機。
* #### DBaaS 服務 + Parse 虛擬機
